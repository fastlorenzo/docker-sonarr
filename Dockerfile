FROM debian:wheezy
MAINTAINER Lorenzo Bernardi <lorenzo@bernardi.be>

# mono 3.10 currently doesn't install in debian jessie due to libpeg8 being removed.

RUN groupadd -g 1023 sonarr && useradd -g sonarr -u 1023 sonarr
...
#  && chown sonarr:sonarr /sonarr-update.sh
